...
func _ready():
	...
	player.stream = load("res://Audio/Sounds/Game/tick-c.ogg")
	player.play()
...
func _on_Area_body_entered(body):
	if body is KinematicBody:
		get_tree().change_scene("res://Scenes/LevelFourJ.tscn")
...
func _on_Area3_body_entered(body):
	if body is KinematicBody:
		var a = sarin_bomb.instance()
		a.transform.origin = Vector3(0,10,-12)
		a.rotate_y(30)
		enemy_container.add_child(a)
...
func _on_Area7_body_entered(body):
	if body is KinematicBody:
		var a = sarin_bomb.instance()
		a.transform.origin = Vector3(29,10,31)
		a.rotate_y(30)
		enemy_container.add_child(a)
...
func _on_Area8_body_entered(body):
	if body is KinematicBody:
		var a = sarin_bomb.instance()
		a.transform.origin = Vector3(-47,10,37)
		a.rotate_y(30)
		enemy_container.add_child(a)
