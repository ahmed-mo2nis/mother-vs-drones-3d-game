...
var train_station_upper = preload("res://Scenes/TrainStationU.tscn")
var train_station_lower = preload("res://Scenes/TrainStationL.tscn")
var train_station_ladder = preload("res://Scenes/Ladder.tscn")
...
func _on_Area_body_entered(body):
	if body is KinematicBody:
		get_tree().change_scene("res://Scenes/CutSceneEndA.tscn")
